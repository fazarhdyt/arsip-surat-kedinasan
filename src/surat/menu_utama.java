...
public class menu_utama extends javax.swing.JFrame {
    ...
    private void auth() {
        if (role != 1) {
            JOptionPane.showMessageDialog(null, "Tidak dapat mengakses menu! ");
    ...
    private void initComponents() {
        ...
        jMenuItem7.setText("Status Surat");
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItem3ActionPerformed
        if (role == 1) {
            ...
            surat_keluar_guru menu = new surat_keluar_guru();
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItem4ActionPerformed
        auth();
        try {
            String path = ".\\src\\Report\\report-surat-masuk.jasper";
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItem5ActionPerformed
        auth();
        try {
            String path = ".\\src\\Report\\report-surat-keluar.jasper";
            Map<String, Object> param = new HashMap();
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItem7ActionPerformed
        auth();
        try {
            String path = ".\\src\\Report\\report-status-surat.jasper";
            Map<String, Object> param = new HashMap();
    ...
    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItem8ActionPerformed
        auth();
        try {
            String path = ".\\src\\Report\\report-disposisi.jasper";
            Map<String, Object> param = new HashMap();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menu_utama.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
